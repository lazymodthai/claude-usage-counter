...
## Windows / macOS Overlay (Tauri)

นอกจาก macOS menu bar app แล้ว ยังมี **overlay version** ที่รองรับทั้ง Windows และ macOS  
เป็นหน้าต่างลอยขนาดเล็กที่ลากย้ายตำแหน่งได้ทุกที่บนหน้าจอ
...
**ดูวิธีติดตั้งและใช้งานได้ที่ [`windows/README.md`](windows/README.md)**
